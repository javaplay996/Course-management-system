...
public class FudaoyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FudaoyuanEntity user = fudaoyuanService.selectOne(new EntityWrapper<FudaoyuanEntity>().eq("fudaoyuanzhanghao", username));
    ...
    public R register(@RequestBody FudaoyuanEntity fudaoyuan){
    	...
    	FudaoyuanEntity user = fudaoyuanService.selectOne(new EntityWrapper<FudaoyuanEntity>().eq("fudaoyuanzhanghao", fudaoyuan.getFudaoyuanzhanghao()));
		if(user!=null) {
