<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在年级" prop="suozainianji">
          <el-input v-model="ruleForm.suozainianji" 
              placeholder="所在年级" clearable  :readonly="ro.suozainianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在年级" prop="suozainianji">
              <el-input v-model="ruleForm.suozainianji" 
                placeholder="所在年级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在班级" prop="suozaibanji">
          <el-input v-model="ruleForm.suozaibanji" 
              placeholder="所在班级" clearable  :readonly="ro.suozaibanji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在班级" prop="suozaibanji">
              <el-input v-model="ruleForm.suozaibanji" 
                placeholder="所在班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="请假天数以及原因" prop="qingjiatianshuyijiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="请假天数以及原因"
                  v-model="ruleForm.qingjiatianshuyijiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qingjiatianshuyijiyuanyin" label="请假天数以及原因" prop="qingjiatianshuyijiyuanyin">
                    <span>{{ruleForm.qingjiatianshuyijiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="缺勤天数及原因" prop="queqintianshujiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="缺勤天数及原因"
                  v-model="ruleForm.queqintianshujiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.queqintianshujiyuanyin" label="缺勤天数及原因" prop="queqintianshujiyuanyin">
                    <span>{{ruleForm.queqintianshujiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	qingjiatianshuyijiyuanyin : false,
	queqintianshujiyuanyin : false,
	tupian : false,
      },
      ruleForm: {
        xueshengzhanghao: '',
        ...
        suozaibanji: '',
        shangkezhuangkuang: '',
        qingjiatianshuyijiyuanyin: '',
        queqintianshujiyuanyin: '',
        tupian: '',
      },
          xingbieOptions: [],
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suozaiyuanxi = true;
          ...
          if(o=='suozainianji'){
            this.ruleForm.suozainianji = obj[o];
	    this.ro.suozainianji = true;
            continue;
          }
          if(o=='suozaibanji'){
	    ...
	    this.ro.shangkezhuangkuang = true;
          ...
          if(o=='qingjiatianshuyijiyuanyin'){
            this.ruleForm.qingjiatianshuyijiyuanyin = obj[o];
	    this.ro.qingjiatianshuyijiyuanyin = true;
            continue;
          }
          if(o=='queqintianshujiyuanyin'){
            this.ruleForm.queqintianshujiyuanyin = obj[o];
	    this.ro.queqintianshujiyuanyin = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
		...
		if(json.suozainianji!=''&&json.suozainianji){
              		this.ruleForm.suozainianji = json.suozainianji
		}
		if(json.suozaibanji!=''&&json.suozaibanji){
              		this.ruleForm.suozaibanji = json.suozaibanji
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.shangkezhuangkuangOptions = "在岗,缺勤,请假".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
