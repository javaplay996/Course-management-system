<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任课院系" prop="renkeyuanxi">
          <el-input v-model="ruleForm.renkeyuanxi" 
              placeholder="任课院系" clearable  :readonly="ro.renkeyuanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任课院系" prop="renkeyuanxi">
              <el-input v-model="ruleForm.renkeyuanxi" 
                placeholder="任课院系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任课年级" prop="renkenianji">
          <el-input v-model="ruleForm.renkenianji" 
              placeholder="任课年级" clearable  :readonly="ro.renkenianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任课年级" prop="renkenianji">
              <el-input v-model="ruleForm.renkenianji" 
                placeholder="任课年级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任课班级" prop="renkebanji">
          <el-input v-model="ruleForm.renkebanji" 
              placeholder="任课班级" clearable  :readonly="ro.renkebanji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任课班级" prop="renkebanji">
              <el-input v-model="ruleForm.renkebanji" 
                placeholder="任课班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshishu = true;
          ...
          if(o=='renkeyuanxi'){
            this.ruleForm.renkeyuanxi = obj[o];
	    this.ro.renkeyuanxi = true;
            continue;
          }
          if(o=='renkenianji'){
            this.ruleForm.renkenianji = obj[o];
	    this.ro.renkenianji = true;
            continue;
          }
          if(o=='renkebanji'){
            this.ruleForm.renkebanji = obj[o];
	    this.ro.renkebanji = true;
            continue;
          }
          if(o=='shangkeshijian'){
    ...
    info(id) {
      this.$http({
        url: `laoshikechengxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `laoshikechengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.laoshikechengxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
