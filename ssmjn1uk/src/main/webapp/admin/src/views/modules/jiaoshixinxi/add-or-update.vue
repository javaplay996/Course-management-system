<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师手机" prop="jiaoshishouji">
          <el-input v-model="ruleForm.jiaoshishouji" 
              placeholder="教师手机" clearable  :readonly="ro.jiaoshishouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师手机" prop="jiaoshishouji">
              <el-input v-model="ruleForm.jiaoshishouji" 
                placeholder="教师手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jiaoshishouji'){
            this.ruleForm.jiaoshishouji = obj[o];
	    this.ro.jiaoshishouji = true;
            continue;
          }
          if(o=='chushengriqi'){
      ...
      this.$http({
		...
		if(json.jiaoshishouji!=''&&json.jiaoshishouji){
              		this.ruleForm.jiaoshishouji = json.jiaoshishouji
		}
		...
		if(json.suoshunianji!=''&&json.suoshunianji){
              		this.ruleForm.suoshunianji = json.suoshunianji
		}
        } else {
