<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('xueshengxinxi','请假') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="xueshengqingjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'请假':'' }}</el-button>
                <el-button v-if="isAuth('xueshengxinxi','请假') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="xueshengqingjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'请假':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xueshengxinxi','请假') && contents.tableBtnIcon == 0" type="success" size="mini" @click="xueshengqingjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'请假':'' }}</el-button>
    ...
    <xueshengqingjiaxinxi-cross-add-or-update v-if="xueshengqingjiaxinxiCrossAddOrUpdateFlag" :parent="this" ref="xueshengqingjiaxinxiCrossaddOrUpdate"></xueshengqingjiaxinxi-cross-add-or-update>
...
import xueshengqingjiaxinxiCrossAddOrUpdate from "../xueshengqingjiaxinxi/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      xueshengqingjiaxinxiCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    xueshengqingjiaxinxiCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    xueshengqingjiaxinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.xueshengqingjiaxinxiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','xueshengxinxi');
      this.$nextTick(() => {
      this.$refs.xueshengqingjiaxinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    },
